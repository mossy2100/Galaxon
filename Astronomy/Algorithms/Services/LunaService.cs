...
public class LunaService(AstroObjectRepository astroObjectRepository)
{
    ...
    public LunarPhase PhaseFromDateTime(DateTime dt)
    {
        ...
        double k = (dt - LUNATION_0_START).Ticks / TimeSpanExtensions.TICKS_PER_LUNATION;
        ...
        DateTime dtPhaseApprox = LUNATION_0_START.AddDays(k * TimeSpanExtensions.DAYS_PER_LUNATION);
    ...
    public List<LunarPhase> PhasesInPeriod(DateTime start, DateTime end)
    {
        ...
        const double daysPerPhase = TimeSpanExtensions.DAYS_PER_LUNATION / 4.0;
    ...
    public List<LunarPhase> PhasesInMonth(int year, int month)
    {
