...
public class FractionFinder
{
    ...
    {
        double frac = TimeSpanExtensions.DAYS_PER_LUNATION - (int)TimeSpanExtensions.DAYS_PER_LUNATION;
        var epsilon = 0.001;
    ...
    public static void TestLongMonthRule()
    {
        ...
        double driftSecondsPerYear = driftSecondsPerDay * TimeSpanExtensions.DAYS_PER_TROPICAL_YEAR;
        double cycleLengthDays = monthsPerCycle * calMonthLengthDays;
        double cycleLengthYears = cycleLengthDays / TimeSpanExtensions.DAYS_PER_TROPICAL_YEAR;
    ...
    {
        double frac = TimeSpanExtensions.DAYS_PER_TROPICAL_YEAR - (int)TimeSpanExtensions.DAYS_PER_TROPICAL_YEAR;
