...
public static class TimeSpanExtensions
{
        ...
        ETimeUnit toUnit = ETimeUnit.Tick)
    {
        var ticks = fromUnit switch
        {
            ...
            ETimeUnit.Month => amount * GregorianCalendarExtensions.TICKS_PER_MONTH,
            ETimeUnit.Year => amount * GregorianCalendarExtensions.TICKS_PER_YEAR,
            ETimeUnit.Decade => amount * GregorianCalendarExtensions.TICKS_PER_YEAR * 10,
            ETimeUnit.Century => amount * GregorianCalendarExtensions.TICKS_PER_YEAR * 100,
            ETimeUnit.Millennium => amount * GregorianCalendarExtensions.TICKS_PER_YEAR * 1000,
        ...
        return toUnit switch
        {
            ...
            ETimeUnit.Month => ticks / GregorianCalendarExtensions.TICKS_PER_MONTH,
            ETimeUnit.Year => ticks / GregorianCalendarExtensions.TICKS_PER_YEAR,
            ETimeUnit.Decade => ticks / (GregorianCalendarExtensions.TICKS_PER_YEAR * 10),
            ETimeUnit.Century => ticks / (GregorianCalendarExtensions.TICKS_PER_YEAR * 100),
            ETimeUnit.Millennium => ticks / (GregorianCalendarExtensions.TICKS_PER_YEAR * 1000),
